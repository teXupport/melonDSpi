...
LegacyEntry LegacyFile[] =
{
    ...
    {"HKKey_Exit",                0, "Keyboard.HK_Exit", true},
    ...
    {"HKKey_SwapPhysicalScreens", 0, "Keyboard.HK_SwapPhysicalScreens", true},
    ...
    {"HKJoy_Exit",                0, "Joystick.HK_Exit", true},
    ...
    {"HKJoy_SwapPhysicalScreens", 0, "Joystick.HK_SwapPhysicalScreens", true},
